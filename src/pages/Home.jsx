...
export default function Home() {
    let chats = [
        {id:1, usrname: "Francis", image : defaultImage, lastMessage: "Good morning sir"},
        {id:2, usrname: "Paul", image : defaultImage, lastMessage: "I'm alright"},
    ]
                ...
                <div className="messages">
                    <div className="message-item">
                        ...
                        <div className="second-col">
                            <div className="first-row">MANUNITED - GIFTCARDS</div>
                            <div className="second-row">Good morning sir</div>
                        </div>
                        <div className="third-col">6 days ago</div>
                    </div>
